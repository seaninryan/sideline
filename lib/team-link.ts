...
// Swap the two sides of a match: home ↔ away across names, colours, rosters, squads, and
// team ids. Returns a partial to spread onto the editor's home/away state/payload.
